...
execute_process(
  COMMAND "/usr/bin/git" show-ref "release-2.26.5"
  WORKING_DIRECTORY "/home/taiwei/code/myBeijingHell/external/SDL2"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/taiwei/code/myBeijingHell/external/SDL2'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/taiwei/code/myBeijingHell/external/SDL2'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
